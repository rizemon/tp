...
public class ErrorMessages {
    ...
    public static final String INVALID_RECIPE_DIRECTORY_FILETYPE = "The recipe folder does not seem "
            + "to be a valid folder, but rather a file, please change it "
            + "to ensure that you can save your recipes created properly";
}
